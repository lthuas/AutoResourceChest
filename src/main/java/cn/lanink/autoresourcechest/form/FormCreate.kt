    ...
    companion object {
        ...
        fun sendChestSetConfig(player: Player, chestManager: ChestManager) {
            ...
            custom.onResponded { res, p ->
                ...
                chestManager.enableOpenAnimation = res.getInputResponse(4).toBoolean()
                chestManager.animationSpeed = res.getInputResponse(5).toInt().coerceAtLeast(1)
                chestManager.animationMode = res.getInputResponse(6)
                chestManager.gradientTransition = res.getInputResponse(7).toBoolean()
                chestManager.animationSound = res.getInputResponse(8).toBoolean()
                chestManager.animationParticle = res.getInputResponse(9).toBoolean()
